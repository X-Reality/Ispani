...
import 'package:ispani/TutoringProfileScreen.dart';
    ...
    final tutors = [
      {
        ...
        'hours': 200,
        'description':
            'The filter elements at the top must (All, Design, Coding, etc.) be horizontally scrollable and include keywords for mobile/web dev.',
          ...
          child: Column(
            ...
            children: [
              Row(
                children: [
                  CircleAvatar(
                      backgroundImage: AssetImage(tutor['avatar']), radius: 24),
